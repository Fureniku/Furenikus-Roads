...
public class RoadsCity { 
    ...
    public void preInit(FMLPreInitializationEvent event) {
    	...
    	coin1 = new ItemCoin(config.coin1ID).setUnlocalizedName("coin1");
    	coin2 = new ItemCoin(config.coin2ID).setUnlocalizedName("coin2");
    	coin5 = new ItemCoin(config.coin5ID).setUnlocalizedName("coin5");
    	coin10 = new ItemCoin(config.coin10ID).setUnlocalizedName("coin10");
    	coin25 = new ItemCoin(config.coin25ID).setUnlocalizedName("coin25");
    	coin50 = new ItemCoin(config.coin50ID).setUnlocalizedName("coin50");
    	coin100 = new ItemCoin(config.coin100ID).setUnlocalizedName("coin100");
    	note100 = new ItemNote(config.note100ID).setUnlocalizedName("note100");
    	note500 = new ItemNote(config.note500ID).setUnlocalizedName("note500");
    	note1000 = new ItemNote(config.note1000ID).setUnlocalizedName("note1000");
    	note2000 = new ItemNote(config.note2000ID).setUnlocalizedName("note2000");
    	note5000 = new ItemNote(config.note5000ID).setUnlocalizedName("note5000");
    	note10000 = new ItemNote(config.note10000ID).setUnlocalizedName("note10000");
