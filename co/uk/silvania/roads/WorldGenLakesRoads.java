...
public class WorldGenLakesRoads extends WorldGenerator {
    private int blockIndex;

    public WorldGenLakesRoads(int par1) {
                ...
                for (j2 = 0; j2 < 16; ++j2) {
                    for (i2 = 0; i2 < 8; ++i2) {
                        if (aboolean[(i1 * 16 + j2) * 8 + i2]) {
                            world.setBlock(x + i1, y + i2, z + j2, i2 >= 4 ? 0 : this.blockIndex, 0, 2);
                        }
                    }
                }
            }
                ...
                for (i1 = 0; i1 < 16; ++i1) {
                    for (j2 = 0; j2 < 16; ++j2) {
                        ...
                        if (world.isBlockFreezable(x + i1, y + b0, z + j2)) {
                            world.setBlock(x + i1, y + b0, z + j2, Roads.generalBlocks.blockID, 0, 2);
                        }
                    }
                }
            }
