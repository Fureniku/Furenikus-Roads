...
public abstract class RoadsTar extends Block
{
    protected RoadsTar(int par1, Material par2Material)
    {
    ...
    public static double getFlowDirection(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, Material par4Material)
    {
        ...
        {
            var5 = ((RoadsTar)Block.waterMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }

        if (par4Material == Material.lava)
        {
            var5 = ((RoadsTar)Block.lavaMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }
