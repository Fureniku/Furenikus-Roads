...
public class SideWalkKerbed1InnerCorner extends Block {

    public SideWalkKerbed1InnerCorner (int id) {
	...
	public void registerIcons(IconRegister iconRegister) {
        this.top = iconRegister.registerIcon("Roads:SideWalkKerbed1InnerCorner");
