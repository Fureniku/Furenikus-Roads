...
public class SideWalkKerbed2InnerCorner extends Block {

    public SideWalkKerbed2InnerCorner (int id) {
	...
	public void registerIcons(IconRegister iconRegister) {
        this.top = iconRegister.registerIcon("Roads:SideWalkKerbed2InnerCorner");
