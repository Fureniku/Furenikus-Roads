...
public class SideWalkKerbed2OuterCorner extends Block {
	...
	public void registerIcons(IconRegister iconRegister) {
        ...
        this.sidesa = iconRegister.registerIcon("Roads:SideWalkKerbed2a");
        this.sidesb = iconRegister.registerIcon("Roads:SideWalkKerbed2InnerCorner");
        this.sidesc = iconRegister.registerIcon("Roads:SideWalkKerbed2InnerCornera");
        this.sidesd = iconRegister.registerIcon("Roads:SideWalkKerbed2InnerCornerb");
        this.sidese = iconRegister.registerIcon("Roads:SideWalkKerbed2b");
        this.base = iconRegister.registerIcon("Roads:sidewalkBlocks2");
	}
