...
public class RBSingleWhiteSide extends Block {

        public RBSingleWhiteSide (int id, int texture, Material material) {
        ...
        public int getBlockTextureFromSideAndMetadata(int par1, int par2)
        {
            ...
            return var3 > 5 ? this.blockIndexInTexture : (par1 == var3 ? 
            		(this.blockIndexInTexture + 1 * 1) : (par1 == Facing.faceToSide[var3] ? 1 : 8));
        }
