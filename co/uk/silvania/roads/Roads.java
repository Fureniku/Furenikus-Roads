...
import co.uk.silvania.roads.tileentities.blocks.TileEntityHalfSlopeBlock;
...
import co.uk.silvania.roads.tileentities.blocks.TileEntityRoadSlope1Block;
import co.uk.silvania.roads.tileentities.blocks.TileEntityRoadSlope2Block;
import co.uk.silvania.roads.tileentities.blocks.TileEntityRoadSlope3Block;
import co.uk.silvania.roads.tileentities.blocks.TileEntityRoadSlope4Block;
import co.uk.silvania.roads.tileentities.blocks.TileEntityRoadSlope5Block;
import co.uk.silvania.roads.tileentities.blocks.TileEntityRoadSlope6Block;
import co.uk.silvania.roads.tileentities.blocks.TileEntityRoadSlope7Block;
...
import co.uk.silvania.roads.tileentities.blocks.TileEntityTrafficHangingBlock;
...
import co.uk.silvania.roads.tileentities.entities.TileEntityHalfSlopeEntity;
...
import co.uk.silvania.roads.tileentities.entities.TileEntityTrafficHangingEntity;
...
public class Roads { 
    ...
    public void preInit(FMLPreInitializationEvent event) {
    	...
    	roadSlope1 = new TileEntityRoadSlope1Block(config.roadSlope1ID).setUnlocalizedName("roadSlope1");
    	roadSlope2 = new TileEntityRoadSlope2Block(config.roadSlope2ID).setUnlocalizedName("roadSlope2");
    	roadSlope3 = new TileEntityRoadSlope3Block(config.roadSlope3ID).setUnlocalizedName("roadSlope3");
    	roadSlope4 = new TileEntityRoadSlope4Block(config.roadSlope4ID).setUnlocalizedName("roadSlope4");
    	roadSlope5 = new TileEntityRoadSlope5Block(config.roadSlope5ID).setUnlocalizedName("roadSlope5");
    	roadSlope6 = new TileEntityRoadSlope6Block(config.roadSlope6ID).setUnlocalizedName("roadSlope6");
    	roadSlope7 = new TileEntityRoadSlope7Block(config.roadSlope7ID).setUnlocalizedName("roadSlope7");
    ...
    public void load(FMLInitializationEvent event) {
            ...
            GameRegistry.registerTileEntity(TileEntityRoadSlope7Entity.class, "tileEntityRoadSlope7");
