...
public class RoadPainterFullModel extends ModelBase
{
  //fields
    ModelRenderer Base;
  ...
  public RoadPainterFullModel()
  {
    ...
    textureHeight = 64;
      ...
      RoadBlock = new ModelRenderer(this, 64, 34);
      RoadBlock.addBox(0F, 0F, 0F, 16, 14, 16);
      RoadBlock.setRotationPoint(-8F, 9F, -8F);
      RoadBlock.setTextureSize(128, 64);
      RoadBlock.mirror = true;
      setRotation(RoadBlock, 0F, 0F, 0F);
