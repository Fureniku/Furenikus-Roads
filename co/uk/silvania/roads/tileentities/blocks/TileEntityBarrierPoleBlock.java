...
public class TileEntityBarrierPoleBlock extends BlockContainer {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess block, int x, int y, int z) {
    	...
    	if (meta == 0) {
        	this.setBlockBounds(0.0F, 0.0F, 0.875F, 1.0F, 0.75F, 1.0F);
    	} else if (meta == 1) {
        	this.setBlockBounds(0.0F, 0.0F, 0.0F, 0.125F, 0.75F, 1.0F);
    	} else if (meta == 2) {
        	this.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 0.75F, 0.125F);
    	} else
        	this.setBlockBounds(0.875F, 0.0F, 0.0F, 1.0F, 0.75F, 1.0F);
	}
