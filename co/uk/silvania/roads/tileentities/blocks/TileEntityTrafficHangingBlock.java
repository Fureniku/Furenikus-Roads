...
public class TileEntityTrafficHangingBlock extends BlockContainer {

	public TileEntityTrafficHangingBlock(int id) {
		super(id, Material.iron);
		this.setCreativeTab(Roads.tabRoads);
    	this.setBlockBounds(0.4F, 0.0F, 0.3F, 0.6F, 4.0F, 0.6F);
		this.setHardness(1.0F);
	}

	@Override
	public TileEntity createNewTileEntity(World world) {
		return new TileEntityTrafficHangingEntity();
	}
