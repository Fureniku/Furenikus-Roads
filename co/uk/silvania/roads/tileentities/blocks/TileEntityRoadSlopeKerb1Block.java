...
import co.uk.silvania.roads.tileentities.entities.TileEntityRoadSlopeKerb1Entity;
...
public class TileEntityRoadSlopeKerb1Block extends BlockContainer {

	public TileEntityRoadSlopeKerb1Block(int id) {
	...
	public TileEntity createNewTileEntity(World world) {
		return new TileEntityRoadSlopeKerb1Entity();
	}
