...
import co.uk.silvania.roads.client.models.StreetLamp1Model;
...
public class TileEntityStreetLamp1Renderer extends TileEntitySpecialRenderer {
	...
	public TileEntityStreetLamp1Renderer() {
		this.model = new StreetLamp1Model();
	}
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z,
		...
		GL11.glPushMatrix();
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("flenixroads", "textures/entities/StreetLamp.png"));
