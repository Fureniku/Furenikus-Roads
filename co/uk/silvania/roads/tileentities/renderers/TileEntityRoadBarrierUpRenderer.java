...
import co.uk.silvania.roads.client.models.BarrierHorizontalModel;
import co.uk.silvania.roads.client.models.BarrierVerticalModel;
...
public class TileEntityRoadBarrierUpRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z,
		...
		GL11.glPushMatrix();
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Roads.modid, "textures/entities/RoadBarrier.png"));
