...
public class TileEntityRoadSlopeRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z,
        ...
        if (i == 4 || i == 5 || i == 6 || i == 7) {
            Minecraft.getMinecraft().renderEngine.func_110577_a(new ResourceLocation("roads", "textures/entities/slope1whitestripefarleft.png"));
        }
        ...
        if (i == 12 || i == 13 || i == 14 || i == 15) {
            Minecraft.getMinecraft().renderEngine.func_110577_a(new ResourceLocation("roads", "textures/entities/slope1whitestripefarright.png"));
        }
