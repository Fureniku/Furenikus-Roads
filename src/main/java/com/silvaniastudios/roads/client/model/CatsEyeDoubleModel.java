...
public class CatsEyeDoubleModel implements IBakedModel {
	...
	public CatsEyeDoubleModel(IBakedModel model_ns, String col, CatsEyeBlock.EnumCatsEye dir) {
		this.model = model_ns;
		this.col = col;
		this.dir = dir;
	...
	public CatsEyeDoubleModel setCurrentItemStack(ItemStack stack) {
		return this;
	}
	
	private static class CatsEyeOverrideList extends ItemOverrideList {
		private CatsEyeDoubleModel model;
		
		public CatsEyeOverrideList(CatsEyeDoubleModel model) {
