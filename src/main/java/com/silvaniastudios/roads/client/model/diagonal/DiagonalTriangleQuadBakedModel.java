...
public class DiagonalTriangleQuadBakedModel extends DiagonalBakedModelBase {
	...
	protected List<BakedQuad> packQuads(EnumFacing facing, TextureAtlasSprite spriteLeft, TextureAtlasSprite spriteRight, float leftHeight, float rightHeight) {
		...
		if (facing == EnumFacing.NORTH) {
			...
			if (spriteRight != null) quads = createTrapezium(quads, left, leftHeight, rightHeight, spriteRight, widthN, widthW, 180);
		} else if (facing == EnumFacing.EAST) {
			if (spriteLeft  != null) quads = createTriangle(quads, left, leftHeight, rightHeight, spriteLeft, widthN, 270);
			if (spriteRight != null) quads = createTrapezium(quads, left, leftHeight, rightHeight, spriteRight, widthN, widthW, 90);
		} else if (facing == EnumFacing.SOUTH) {
			if (spriteLeft  != null) quads = createTriangle(quads, left, leftHeight, rightHeight, spriteLeft, widthN, 180);
			if (spriteRight != null) quads = createTrapezium(quads, left, leftHeight, rightHeight, spriteRight, widthN, widthW, 0);
		} else {
			if (spriteLeft  != null) quads = createTriangle(quads, left, leftHeight, rightHeight, spriteLeft, widthN, 90);
			if (spriteRight != null) quads = createTrapezium(quads, left, leftHeight, rightHeight, spriteRight, widthN, widthW, 270);
		}
