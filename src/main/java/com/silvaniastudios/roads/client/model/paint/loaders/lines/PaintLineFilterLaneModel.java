...
public class PaintLineFilterLaneModel extends PaintModelBase {

    @Override
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        return new PaintLineFilterLaneBakedModel(state, format, bakedTextureGetter);
    }
}

class PaintLineFilterLaneBakedModel extends PaintLineBakedModelBase {

    public PaintLineFilterLaneBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        if (state != null) {
            ...
            if (sprite != null) {
                switch (facing) {
                    case NORTH:
                    case SOUTH:
                        rawQuads.addAll(shapeLine(format, sprite, v*5f, v*2f, v*11f, v*14f, 0f, 0f, 0f, 0f));
                        break;
                    case EAST:
                    case WEST:
                        rawQuads.addAll(shapeLine(format, sprite, v*2f, v*5f, v*14f, v*11f, 0f, 0f, 0f, 0f));
                        break;
                }
