...
public class Diagonal14MirrorModelLoader implements ICustomModelLoader {
	
	public static final DiagonalTriangleQuadModel MODEL = new DiagonalTriangleQuadModel(0.75, 1.0, false);
