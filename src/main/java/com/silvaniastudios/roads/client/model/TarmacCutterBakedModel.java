...
public class TarmacCutterBakedModel implements IBakedModel {
	...
	public TarmacCutterBakedModel(IBakedModel model, String rot) {
		this.model = model;
		this.rot = rot;
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
		...
		if (rot.equalsIgnoreCase("north")) {
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					0.74F*p, 1.75F*p, 2F *p, 
					0.74F*p, 1.75F*p, 14F*p,
					0.74F*p, 7.25F*p, 14F*p,
					0.74F*p, 7.25F*p, 2F *p), 0.007F));
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					15.26F*p, 1.75F*p, 14F*p, 
					15.26F*p, 1.75F*p, 2F *p,
					15.26F*p, 7.25F*p, 2F *p,
					15.26F*p, 7.25F*p, 14F*p), 0.007F));
		}
		
		if (rot.equalsIgnoreCase("west")) {
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					14F*p, 1.75F*p, 0.74F*p, 
					2F *p, 1.75F*p, 0.74F*p,
					2F *p, 7.25F*p, 0.74F*p,
					14F*p, 7.25F*p, 0.74F*p), 0.007F));
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					2F *p, 1.75F*p, 15.26F*p, 
					14F*p, 1.75F*p, 15.26F*p,
					14F*p, 7.25F*p, 15.26F*p,
					2F *p, 7.25F*p, 15.26F*p), 0.007F));
		}
	...
	public TarmacCutterBakedModel setCurrentItemStack(ItemStack stack) {
		return this;
	}
	
	private static class CatsEyeOverrideList extends ItemOverrideList {
		private TarmacCutterBakedModel model;
		
		public CatsEyeOverrideList(TarmacCutterBakedModel model) {
