...
public class DiagonalRoadModel implements IBakedModel {
	...
	public DiagonalRoadModel(IBakedModel model, String rot) {
		this.model = model;
		this.rot = rot;
	...
	public DiagonalRoadModel setCurrentItemStack(ItemStack stack) {
		return this;
	}
	
	private static class CrusherOverrideList extends ItemOverrideList {
		private DiagonalRoadModel model;
		
		public CrusherOverrideList(DiagonalRoadModel model) {
