...
public class LineSideDoubleThickModelLoader implements ICustomModelLoader {
	
	public static final PaintLineSideDoubleThickModel MODEL = new PaintLineSideDoubleThickModel();
	
	@Override
	public boolean accepts(ResourceLocation modelLocation) {
		if (modelLocation.getResourceDomain().equals(FurenikusRoads.MODID)) {
			for (int i = 0; i < FRBlocks.col.length; i++) {
				if (modelLocation.getResourcePath().equals("line_" + FRBlocks.col[i].getName() + "_side_double_thick")) {
					return true;
				}
			}
		}
...
class PaintLineSideDoubleThickModel extends PaintModelBase {
	
	@Override
	public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
		return new PaintLineSideDoubleThickBakedModel(state, format, bakedTextureGetter);
	}
}

class PaintLineSideDoubleThickBakedModel extends PaintBakedModelBase {

	public PaintLineSideDoubleThickBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
	...
	protected List<BakedQuad> packQuads(IExtendedBlockState state) {
		...
		if (state != null) {
			...
			if (sprite != null) {
				//central line
				List<Quad> central_a = shapeLine(format, sprite, v*7, v*2, v*9, v*4, 0f, 0f, 0f, 0f);
				List<Quad> central_b = shapeLine(format, sprite, v*7, v*5, v*9, v*7, 0f, 0f, 0f, 0f);
				
				//connectors left
				List<Quad> connect_left_tl = shapeLine(format, sprite, v*2, v*2, v*4, v*4, 0f, 0f, 0f, 0f);
				List<Quad> connect_left_tr = shapeLine(format, sprite, v*5, v*2, v*7, v*4, 0f, 0f, 0f, 0f);
				List<Quad> connect_left_bl = shapeLine(format, sprite, v*2, v*5, v*4, v*7, 0f, 0f, 0f, 0f);
				List<Quad> connect_left_br = shapeLine(format, sprite, v*5, v*5, v*7, v*7, 0f, 0f, 0f, 0f);
				
				List<Quad> connect_left_widget_t = shapeLine(format, sprite, v*4, v*2, v*5, v*4, 0f, 0f, 0f, 0f);
				List<Quad> connect_left_widget_b = shapeLine(format, sprite, v*4, v*5, v*5, v*7, 0f, 0f, 0f, 0f);
				List<Quad> connect_left_widget_l = shapeLine(format, sprite, v*2, v*4, v*4, v*5, 0f, 0f, 0f, 0f);
				List<Quad> connect_left_widget_r = shapeLine(format, sprite, v*5, v*4, v*7, v*5, 0f, 0f, 0f, 0f);
				
				//lines left
				List<Quad> left_up_a = shapeLine(format, sprite, v*2, v*0, v*4, v*2, 0f, 0f, 0f, 0f);
				List<Quad> left_up_b = shapeLine(format, sprite, v*5, v*0, v*7, v*2, 0f, 0f, 0f, 0f);
				
				List<Quad> left_mid_a = shapeLine(format, sprite, v*0, v*2, v*2, v*4, 0f, 0f, 0f, 0f);
				List<Quad> left_mid_b = shapeLine(format, sprite, v*0, v*5, v*2, v*7, 0f, 0f, 0f, 0f);
				
				List<Quad> left_down_a = shapeLine(format, sprite, v*2, v*7, v*4, v*16, 0f, 0f, 0f, 0f);
				List<Quad> left_down_b = shapeLine(format, sprite, v*5, v*7, v*7, v*16, 0f, 0f, 0f, 0f);
				
				//connectors right
				List<Quad> connect_right_tl = shapeLine(format, sprite, v*9,  v*2, v*11, v*4, 0f, 0f, 0f, 0f);
				List<Quad> connect_right_tr = shapeLine(format, sprite, v*12, v*2, v*14, v*4, 0f, 0f, 0f, 0f);
				List<Quad> connect_right_bl = shapeLine(format, sprite, v*9,  v*5, v*11, v*7, 0f, 0f, 0f, 0f);
				List<Quad> connect_right_br = shapeLine(format, sprite, v*12, v*5, v*14, v*7, 0f, 0f, 0f, 0f);
				
				List<Quad> connect_right_widget_t = shapeLine(format, sprite, v*11, v*2, v*12, v*4, 0f, 0f, 0f, 0f);
				List<Quad> connect_right_widget_b = shapeLine(format, sprite, v*11, v*5, v*12, v*7, 0f, 0f, 0f, 0f);
				List<Quad> connect_right_widget_l = shapeLine(format, sprite, v*9,  v*4, v*11, v*5, 0f, 0f, 0f, 0f);
				List<Quad> connect_right_widget_r = shapeLine(format, sprite, v*12, v*4, v*14, v*5, 0f, 0f, 0f, 0f);
				
				//lines right
				List<Quad> right_up_a = shapeLine(format, sprite, v*9,  v*0, v*11, v*2, 0f, 0f, 0f, 0f);
				List<Quad> right_up_b = shapeLine(format, sprite, v*12, v*0, v*14, v*2, 0f, 0f, 0f, 0f);
				
				List<Quad> right_mid_a = shapeLine(format, sprite, v*14, v*2, v*16, v*4, 0f, 0f, 0f, 0f);
				List<Quad> right_mid_b = shapeLine(format, sprite, v*14, v*5, v*16, v*7, 0f, 0f, 0f, 0f);
				
				List<Quad> right_down_a = shapeLine(format, sprite, v*9,  v*7, v*11, v*16, 0f, 0f, 0f, 0f);
				List<Quad> right_down_b = shapeLine(format, sprite, v*12, v*7, v*14, v*16, 0f, 0f, 0f, 0f);
