...
public class CatsEyeTwoSidedModel implements IBakedModel {
	...
	public CatsEyeTwoSidedModel(IBakedModel model_ns, String colLeft, String colRight, CatsEyeBlockFourWay.EnumCatsEye dir) {
		this.model = model_ns;
	...
	public CatsEyeTwoSidedModel setCurrentItemStack(ItemStack stack) {
		return this;
	}
	
	private static class CatsEyeOverrideList extends ItemOverrideList {
		private CatsEyeTwoSidedModel model;
		
		public CatsEyeOverrideList(CatsEyeTwoSidedModel model) {
