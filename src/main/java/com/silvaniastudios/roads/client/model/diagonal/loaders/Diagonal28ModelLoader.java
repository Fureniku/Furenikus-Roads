...
public class Diagonal28ModelLoader implements ICustomModelLoader {
	
	public static final DiagonalQuadQuadModel MODEL = new DiagonalQuadQuadModel(0.125, 0.25, true);
