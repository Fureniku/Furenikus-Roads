...
public class Diagonal11ModelLoader implements ICustomModelLoader {
	
	public static final DiagonalTriangleModel MODEL = new DiagonalTriangleModel(true);
	
	@Override
	public boolean accepts(ResourceLocation modelLocation) {
		return modelLocation.getResourceDomain().equals(FurenikusRoads.MODID) && "diagonal_11".equals(modelLocation.getResourcePath());
	}
