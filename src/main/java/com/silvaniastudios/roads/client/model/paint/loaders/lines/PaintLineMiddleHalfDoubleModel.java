...
public class PaintLineMiddleHalfDoubleModel extends PaintModelBase {

    @Override
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        return new PaintLineMiddleHalfDoubleBakedModel(state, format, bakedTextureGetter);
    }
}

class PaintLineMiddleHalfDoubleBakedModel extends PaintLineBakedModelBase {

    public PaintLineMiddleHalfDoubleBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
