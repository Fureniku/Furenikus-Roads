...
public class TarDistillerBakedModel implements IBakedModel {
	...
	public TarDistillerBakedModel(IBakedModel model, String rot) {
		this.model = model;
		this.rot = rot;
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
		...
		if (rot.equalsIgnoreCase("north")) {
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					9.75F*p, 1.75F*p, 1.74F*p, 
					2.5F *p, 1.75F*p, 1.74F*p,
					2.5F *p,    6F*p, 1.74F*p,
					9.75F*p,    6F*p, 1.74F*p), 0.007F));
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					2.5F *p, 1.75F*p, 14.26F*p, 
					9.75F*p, 1.75F*p, 14.26F*p,
					9.75F*p,    6F*p, 14.26F*p,
					2.5F *p,    6F*p, 14.26F*p), 0.007F));
		}
		
		if (rot.equalsIgnoreCase("west")) {
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					1.74F*p, 1.75F*p, (16-9.75F)*p, 
					1.74F*p, 1.75F*p, (16-2.5F) *p,
					1.74F*p,    6F*p, (16-2.5F) *p,
					1.74F*p,    6F*p, (16-9.75F)*p), 0.007F));
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					14.26F*p, 1.75F*p, (16-2.5F) *p, 
					14.26F*p, 1.75F*p, (16-9.75F)*p,
					14.26F*p,    6F*p, (16-9.75F)*p,
					14.26F*p,    6F*p, (16-2.5F) *p), 0.007F));
		}
		
		if (rot.equalsIgnoreCase("south")) {
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					(16-2.5F) *p, 1.75F*p, 1.74F*p, 
					(16-9.75F)*p, 1.75F*p, 1.74F*p,
					(16-9.75F)*p,    6F*p, 1.74F*p,
					(16-2.5F) *p,    6F*p, 1.74F*p), 0.007F));
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					(16-9.75F)*p, 1.75F*p, 14.26F*p, 
					(16-2.5F) *p, 1.75F*p, 14.26F*p,
					(16-2.5F) *p,    6F*p, 14.26F*p,
					(16-9.75F)*p,    6F*p, 14.26F*p), 0.007F));
		}
		
		if (rot.equalsIgnoreCase("east")) {
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					1.74F*p, 1.75F*p, 2.5F *p, 
					1.74F*p, 1.75F*p, 9.75F*p,
					1.74F*p,    6F*p, 9.75F*p,
					1.74F*p,    6F*p, 2.5F *p), 0.007F));
			quadList.add(RenderHelper.setBrightTexture(light(tex,
					//SW SE NE NW
					14.26F*p, 1.75F*p, 9.75F*p, 
					14.26F*p, 1.75F*p, 2.5F *p,
					14.26F*p,    6F*p, 2.5F *p,
					14.26F*p,    6F*p, 9.75F*p), 0.007F));
		}
	...
	public TarDistillerBakedModel setCurrentItemStack(ItemStack stack) {
		return this;
	}
	...
	private static class CatsEyeOverrideList extends ItemOverrideList {
		...
		public CatsEyeOverrideList(TarDistillerBakedModel model) {
