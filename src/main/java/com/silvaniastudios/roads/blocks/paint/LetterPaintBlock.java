...
public class LetterPaintBlock extends PaintBlockBase implements IMetaBlockName {
	
	public static final PropertyEnum<EnumRotatable> ROTATE_ID = PropertyEnum.create("letter_paint", EnumRotatable.class);

	public LetterPaintBlock(String name) {
		super(name);
