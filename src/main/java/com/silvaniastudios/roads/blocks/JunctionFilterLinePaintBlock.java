...
public class JunctionFilterLinePaintBlock extends PaintBlockBase {
	...
	private EnumChevronConnections connectToChevron(IBlockAccess world, BlockPos pos) {
		...
		boolean blockNorth = world.getBlockState(pos.offset(EnumFacing.NORTH)).getBlock() instanceof ChevronPaintBlock;
		boolean blockEast  = world.getBlockState(pos.offset(EnumFacing.EAST)) .getBlock() instanceof ChevronPaintBlock;
		boolean blockSouth = world.getBlockState(pos.offset(EnumFacing.SOUTH)).getBlock() instanceof ChevronPaintBlock;
		boolean blockWest  = world.getBlockState(pos.offset(EnumFacing.WEST)) .getBlock() instanceof ChevronPaintBlock;
		...
		if (blockSide) {
			ChevronPaintBlock.EnumJunctionConnections cnct = (ChevronPaintBlock.EnumJunctionConnections) stateSide.getProperties().get(ChevronPaintBlock.TYPE);
