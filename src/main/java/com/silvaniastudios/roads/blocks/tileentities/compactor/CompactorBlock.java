...
public class CompactorBlock extends RoadTEBlock {

	public CompactorBlock(String name, boolean electric) {
		super(name, electric, 13);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.add(I18n.format("roads.gui.compactor.tooltip_1"));
	}
	...
	public void openGui(World world, BlockPos pos, EntityPlayer player) {
		...
		if (!world.isRemote) {
			if (te != null && te instanceof RoadTileEntity) {
				player.openGui(FurenikusRoads.instance, (electric ? 14 : 13), world, pos.getX(), pos.getY(), pos.getZ());
			}
		}
	}
	...
	public TileEntity createTileEntity(World worldIn, IBlockState state) {
		if (electric) {
			return new CompactorElectricEntity();
		}
		return new CompactorEntity();
	}
	
	@Override
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
    	return new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 0.78D, 0.875D);
    }
