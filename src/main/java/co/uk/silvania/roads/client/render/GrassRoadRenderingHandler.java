...
public class GrassRoadRenderingHandler implements ISimpleBlockRenderingHandler {
	...
	public void renderInventoryBlock(Block block, int meta, int modelId, RenderBlocks renderer) {
		...
		IIcon icon = block.getIcon(0, meta); //Top
		IIcon icon1 = block.getIcon(1, meta); //Overlay
		IIcon icon2 = block.getIcon(2, meta); //Dirt
        ...
        tess.addVertexWithUV(1, a, 0, u1_2, v1_2);
        tess.addVertexWithUV(1, 0, 0, u1_2, v0_2);
        tess.addVertexWithUV(0, 0, 0, u0_2, v0_2);
        tess.addVertexWithUV(0, a, 0, u0_2, v1_2);
        tess.draw();
        
        tess.startDrawingQuads();
        tess.setNormal(0.0F, FACE_Y_NORMAL, -FACE_XZ_NORMAL);
        tess.setColorOpaque_I(grassCol);
        tess.addVertexWithUV(1, a, 0, u0_1, v0_1);
        tess.addVertexWithUV(1, 0, 0, u0_1, v1_1);
        tess.addVertexWithUV(0, 0, 0, u1_1, v1_1);
        tess.addVertexWithUV(0, a, 0, u1_1, v0_1);
        tess.draw();
        ...
        tess.addVertexWithUV(1, a, 1, u1_2, v1_2);
        tess.addVertexWithUV(1, 0, 1, u1_2, v0_2);
        tess.addVertexWithUV(1, 0, 0, u0_2, v0_2);
        tess.addVertexWithUV(1, a, 0, u0_2, v1_2);
        tess.draw();
        
        tess.startDrawingQuads();
        tess.setNormal(FACE_XZ_NORMAL, FACE_Y_NORMAL, 0.0F);
        tess.setColorOpaque_I(grassCol);
        tess.addVertexWithUV(1, a, 1, u0_1, v0_1);
        tess.addVertexWithUV(1, 0, 1, u0_1, v1_1);
        tess.addVertexWithUV(1, 0, 0, u1_1, v1_1);
        tess.addVertexWithUV(1, a, 0, u1_1, v0_1);
        tess.draw();
        ...
        tess.startDrawingQuads();
        tess.setNormal(0.0F, FACE_Y_NORMAL, FACE_XZ_NORMAL);
        tess.addVertexWithUV(0, a, 1, u1_2, v1_2);
        tess.addVertexWithUV(0, 0, 1, u1_2, v0_2);
        tess.addVertexWithUV(1, 0, 1, u0_2, v0_2);
        tess.addVertexWithUV(1, a, 1, u0_2, v1_2);
        tess.draw();
        
        tess.startDrawingQuads();
        tess.setNormal(0.0F, FACE_Y_NORMAL, FACE_XZ_NORMAL);
        tess.setColorOpaque_I(grassCol);
        tess.addVertexWithUV(0, a, 1, u0_1, v0_1);
        tess.addVertexWithUV(0, 0, 1, u0_1, v1_1);
        tess.addVertexWithUV(1, 0, 1, u1_1, v1_1);
        tess.addVertexWithUV(1, a, 1, u1_1, v0_1);
        tess.draw();
        ...
        tess.startDrawingQuads();
        tess.setNormal(-FACE_XZ_NORMAL, FACE_Y_NORMAL, 0.0F);
        tess.addVertexWithUV(0, a, 0, u1_2, v1_2);
        tess.addVertexWithUV(0, 0, 0, u1_2, v0_2);
        tess.addVertexWithUV(0, 0, 1, u0_2, v0_2);
        tess.addVertexWithUV(0, a, 1, u0_2, v1_2);
        tess.draw();
        
        tess.startDrawingQuads();
        tess.setNormal(-FACE_XZ_NORMAL, FACE_Y_NORMAL, 0.0F);
        tess.setColorOpaque_I(grassCol);
        tess.addVertexWithUV(0, a, 0, u0_1, v0_1);
        tess.addVertexWithUV(0, 0, 0, u0_1, v1_1);
        tess.addVertexWithUV(0, 0, 1, u1_1, v1_1);
        tess.addVertexWithUV(0, a, 1, u1_1, v0_1);
        tess.draw();
        ...
        tess.startDrawingQuads();
        tess.setNormal(0.0F, -1.0F, 0.0F);
        tess.addVertexWithUV(0, 0, 1, u1_2, v1_2);
        tess.addVertexWithUV(0, 0, 0, u1_2, v0_2);
        tess.addVertexWithUV(1, 0, 0, u0_2, v0_2);
        tess.addVertexWithUV(1, 0, 1, u0_2, v1_2);
        tess.draw();
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
        ...
        icon = block.getIcon(renderer.blockAccess, x, y, z, 0); //Grass top
        icon1 = block.getIcon(renderer.blockAccess, x, y, z, 1); //Grass side overlay
        icon2 = block.getIcon(renderer.blockAccess, x, y, z, 2); //Dirt

        double u0 = (double)icon.getMinU(); //Grass top
        double u1 = (double)icon.getMaxU();
        
        double v0 = (double)icon.getMinV();
        double v1 = (double)icon.getMaxV();
        
        double u0_1 = (double)icon1.getMinU(); //Grass side overlay
        double u1_1 = (double)icon1.getMaxU();
        
        double v0_1 = (double)icon1.getMinV();
        double v1_1 = (double)icon1.getMaxV();
        
        double u0_2 = (double)icon2.getMinU(); //Dirt
        double u1_2 = (double)icon2.getMaxU();
